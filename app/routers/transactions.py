...
from ..models import Currency, Transaction, TransactionType, User
from ..schemas import BalanceResponse, TransactionCreate, TransactionRead
...
def create_transaction(
    ...
    if transaction.transaction_type == TransactionType.TRANSFER:
        if not transaction.recipient_id:
            raise HTTPException(
                status_code=400, detail="Recipient ID is required for transfers"
            )
